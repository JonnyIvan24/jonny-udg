			...
			<footer id="footer">
				<div class="container">
                    <ul class="icons">
                        ...
                        <li><a href="../proyectoWeb/pages/quienes.php">Quienes somos</a></li>
                        <li><a href="../proyectoWeb/pages/servicios.php">Nuestros servicios</a></li>
                        <li><a href="../proyectoWeb/pages/ubicacion.php">Ubicación</a></li>
                        <li><a href="../proyectoWeb/pages/contacto_directo.php">Contacto directo</a></li>
                    </ul>
					<ul class="icons">
